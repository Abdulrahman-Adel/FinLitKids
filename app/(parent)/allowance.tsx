  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.container}>
        <Ionicons name="construct-outline" size={60} color={colors.placeholder} style={{ marginBottom: 20 }} />
        <Text style={[styles.placeholderText, { color: colors.text }]}>Allowance Feature</Text>
